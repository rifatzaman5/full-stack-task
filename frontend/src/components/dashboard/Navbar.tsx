        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link href="/projects" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white hidden sm:block">Project Billing</span>
            </Link>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-primary-700 border-t border-primary-500">
          <div className="px-4 py-4 space-y-3">
            <Link 
              href="/projects" 
              className="block text-white/90 hover:text-white px-3 py-2 rounded-md text-base font-medium hover:bg-white/10"
            ...
            {user && (
              <div className="bg-white/10 px-3 py-3 rounded-lg">
            ...
            <button
              onClick={handleLogout}
              className="w-full bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-lg text-base font-medium transition-colors flex items-center justify-center space-x-2"
            >
